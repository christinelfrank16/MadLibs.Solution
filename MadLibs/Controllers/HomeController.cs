...
namespace MadLib.Controllers
{
  public class HomeController : Controller
  {
      ...
      [Route("/halloween")]
      public ActionResult Story(string noun, string verb_ing, string noun2, string noun3, string bodypart, string noun4, string verb_ing2, string bodypart_pl, string verb_ing3, string furniture, string noun5, string bodypart2, string adverb, string bodypart3)
      {
